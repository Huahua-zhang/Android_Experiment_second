...
public class Edit extends AppCompatActivity implements OnClickListener {
    ...
    private void InitNote() {       //进行数据填装
        ...
        Cursor cursor = db.query("Note", new String[]{"id", "title", "content", "photo"}, "id=?", new String[]{tran + ""}, null, null, null);
        ...
        String name = pref.getString("author", "zyh");      //通过sharedpreferences传递作者信息
